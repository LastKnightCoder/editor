...
export const filterTimeRecordsByYear = (
...
export const filterTimeRecordsByQuarter = (
  timeRecords: TimeRecordGroup,
  year: string,
  quarter: string,
): TimeRecordGroup => {
  return timeRecords.filter((timeRecord) => {
    ...
    return (
      ...
      Math.floor(dateMonth / 3) + 1 === Number(quarter)
    );
  });
};

export const filterTimeRecordsByMonth = (
  timeRecords: TimeRecordGroup,
  year: string,
  month: string,
): TimeRecordGroup => {
...
export const filterTimeRecordsByWeek = (
  timeRecords: TimeRecordGroup,
  year: string,
  week: string,
): TimeRecordGroup => {
...
export const filterTimeRecordsByDate = (
  timeRecords: TimeRecordGroup,
  date: string,
): TimeRecordGroup => {
  return timeRecords.filter((timeRecord) => {
...
export const filterTimeRecordsByDateRange = (
  timeRecords: TimeRecordGroup,
  startDate: string,
  endDate: string,
): TimeRecordGroup => {
