...
export const filterDailyNoteByYear = (
  dailyNotes: DailyNote[],
  year: string,
) => {
  // 根据年份筛选日记
...
export const filterDailyNoteByQuarter = (
  dailyNotes: DailyNote[],
  year: string,
  quarter: string,
) => {
...
export const filterDailyNoteByMonth = (
  dailyNotes: DailyNote[],
  year: string,
  month: string,
) => {
...
export const filterDailyNoteByWeek = (
  dailyNotes: DailyNote[],
  year: string,
  week: string,
) => {
...
export const filterDailyNoteByDate = (
  dailyNotes: DailyNote[],
  date: string,
) => {
  // 根据日筛选日记
...
export const filterDailyNoteByRange = (
  dailyNotes: DailyNote[],
  start: string,
  end: string,
) => {
