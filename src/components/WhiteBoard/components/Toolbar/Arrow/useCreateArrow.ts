...
import { useCreateElementType, useMoveArrow, useViewPort, useBoard } from "../../../hooks/index";
import { ArrowElement, EArrowLineType, ECreateBoardElementType, EMarkerType, Point } from "../../../types";
...
export const useCreateArrow = () => {
  ...
  useEffect(() => {
    if (createBoardElementType !== ECreateBoardElementType.StraightArrow) return;
