  ...
  return (
    ...
    >
      ...
      <Popover
        ...
        content={(
          <BlockPicker triangle={'hide'} color={element.lineColor} onChange={onSelectColor} />
        )}
      >
        <Tooltip title={'颜色'} placement={'left'}>
          <div className={styles.item}>
            <BiSolidColorFill width={20} height={20} color={element.lineColor} />
          </div>
        </Tooltip>
      </Popover>
      <Popover
