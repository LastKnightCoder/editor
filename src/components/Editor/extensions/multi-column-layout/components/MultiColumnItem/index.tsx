...
import { ReactEditor, RenderElementProps, useSlate, useReadOnly, useSlateSelection } from "slate-react";
...
const MultiColumnItem = (props: IMultiColumnItemProps) => {
  ...
  return (
    <div className={classnames(styles.itemContainer, { [styles.notLast]: !isLast })}>
