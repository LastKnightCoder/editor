                  ...
                  onClickDelete={async () => {
                    ...
                    modal.confirm({
                      ...
                      onOk: async () => {
                        useSettingStore.setState(
                          produce((state) => {
                            state.setting.database.databases =
                              state.setting.database.databases.filter(
                                (item: { name: string }) =>
